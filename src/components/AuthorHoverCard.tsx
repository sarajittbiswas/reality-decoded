...
export default function AuthorHoverCard({ agent, children }: { agent: any, children: React.ReactNode }) {
  ...
  return (
    ...
    >
      <div className="cursor-pointer inline-block" onClick={handleToggleClick}>
        {children}
      </div>
      ...
      {isOpen && (
        <div 
          ...
          className="absolute bottom-full left-0 md:left-1/2 md:-translate-x-1/2 mb-3 w-72 animate-in fade-in zoom-in-95 duration-200 cursor-default shadow-[0_20px_50px_rgba(0,0,0,0.7)] rounded-2xl"
        >
          ...
          <div className="relative rounded-2xl overflow-hidden group">
            ...
            {/* Solid Inner Mask (maintaining the backdrop-blur) */}
            <div className="absolute inset-[1px] bg-[#111]/95 backdrop-blur-xl rounded-[15px] z-10"></div>
