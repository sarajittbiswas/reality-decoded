...
<div className="flex flex-col gap-4 sm:gap-6">
  ...
  <article className="group relative bg-[#111111]/80 backdrop-blur-xl p-5 sm:p-8 rounded-3xl border border-white/5 transition-all duration-500 hover:-translate-y-1 hover:border-red-500/40 hover:shadow-[0_10px_40px_rgba(220,38,38,0.15)] overflow-hidden">
    ...
    <div className="flex items-start gap-4 sm:gap-6 relative z-10">
      <div className="w-10 h-10 sm:w-14 sm:h-14 shrink-0 rounded-2xl bg-red-500/10 border border-red-500/20 flex items-center justify-center group-hover:scale-110 group-hover:bg-red-500/20 transition-all duration-500">
        <svg className="w-5 h-5 sm:w-6 sm:h-6 text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg>
      </div>
      <div className="w-full">
        <h3 className={`${spaceGrotesk.className} text-lg sm:text-xl font-bold text-white mb-2 group-hover:text-red-400 transition-colors`}>Secure Tip Line</h3>
        ...
        <div className="flex flex-col xl:flex-row items-start gap-3 xl:gap-4">
          ...
          <a href="/public-key.asc" download className="text-red-500 text-xs sm:text-sm font-bold hover:text-red-400 transition-colors flex items-center gap-1 shrink-0">
            Download PGP Key <span>&darr;</span>
          </a>
          <a href="mailto:admin@realitydecoded.in" className="text-gray-500 text-xs sm:text-sm font-bold hover:text-white transition-colors">
  ...
  <article className="group relative bg-[#111111]/80 backdrop-blur-xl p-5 sm:p-8 rounded-3xl border border-white/5 transition-all duration-500 hover:-translate-y-1 hover:border-purple-500/40 hover:shadow-[0_10px_40px_rgba(168,85,247,0.15)] overflow-hidden">
    ...
    <div className="flex items-start gap-4 sm:gap-6 relative z-10">
      <div className="w-10 h-10 sm:w-14 sm:h-14 shrink-0 rounded-2xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center group-hover:scale-110 group-hover:bg-purple-500/20 transition-all duration-500">
        <svg className="w-5 h-5 sm:w-6 sm:h-6 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
      </div>
      <div className="w-full">
        <h3 className={`${spaceGrotesk.className} text-lg sm:text-xl font-bold text-white mb-2 group-hover:text-purple-300 transition-colors`}>General Inquiries</h3>
        <p className="text-gray-400 text-xs sm:text-sm leading-relaxed mb-4">
          Questions about our investigations, feedback on recent videos, or ideas for future stories.
        </p>
        <div className="flex flex-col gap-2">
          <a href="mailto:info@realitydecoded.in" className="text-purple-400 text-xs sm:text-sm font-bold hover:text-purple-300 transition-colors">
            info@realitydecoded.in
          </a>
          <a href="mailto:hello@realitydecoded.in" className="text-purple-400 text-xs sm:text-sm font-bold hover:text-purple-300 transition-colors">
  ...
  <article className="group relative bg-[#111111]/80 backdrop-blur-xl p-5 sm:p-8 rounded-3xl border border-white/5 transition-all duration-500 hover:-translate-y-1 hover:border-blue-500/40 hover:shadow-[0_10px_40px_rgba(59,130,246,0.15)] overflow-hidden">
    ...
    <div className="flex items-start gap-4 sm:gap-6 relative z-10">
      <div className="w-10 h-10 sm:w-14 sm:h-14 shrink-0 rounded-2xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center group-hover:scale-110 group-hover:bg-blue-500/20 transition-all duration-500">
        <svg className="w-5 h-5 sm:w-6 sm:h-6 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9.5a2 2 0 00-2-2h-2"></path></svg>
      </div>
      <div className="w-full">
        <h3 className={`${spaceGrotesk.className} text-lg sm:text-xl font-bold text-white mb-2 group-hover:text-blue-300 transition-colors`}>Press & Media</h3>
        <p className="text-gray-400 text-xs sm:text-sm leading-relaxed mb-4">
          For interview requests, media syndication, or collaboration with other creators.
        </p>
        <a href="mailto:business@realitydecoded.in" className="text-blue-400 text-xs sm:text-sm font-bold hover:text-blue-300 transition-colors">
