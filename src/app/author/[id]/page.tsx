...
export default async function AuthorProfilePage(props: { 
  ...
  return (
    <main className="w-full bg-[#000000] text-white min-h-screen pt-32 pb-32 overflow-x-hidden">
      ...
      {/* 1. Pure Grid without any forced alignments */}
      <div className="max-w-[1400px] w-full mx-auto px-5 sm:px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-12 lg:gap-24">
        
        {/* 2. THE BULLETPROOF FIX: This invisible div stretches to the exact height of the articles section */}
        <div className="w-full h-full relative">
          
          {/* 3. The aside now lives inside the wrapper, free to be sticky without jumping */}
          <aside className="flex flex-col lg:sticky top-32 w-full">
